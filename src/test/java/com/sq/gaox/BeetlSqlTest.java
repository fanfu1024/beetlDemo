...
public class BeetlSqlTest {
    ...
    @Test
    public void getPojoCode() throws Exception {
        sqlManager.genPojoCode("sys_teacher","com.test");
//        sqlManager.genSQLTemplateToConsole("sys_teacher");
        sqlManager.genBuiltInSqlToConsole(SysTeacher.class);
    }
}
